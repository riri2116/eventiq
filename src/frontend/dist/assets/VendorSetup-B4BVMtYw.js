import { a as useAuth, u as useNavigate, r as reactExports, j as jsxRuntimeExports, L as Link } from "./index-ByRRMFAm.js";
import { L as Layout, a as LayoutDashboard } from "./Layout-DlYh07ze.js";
import { B as Badge } from "./badge-DT7h_gAr.js";
import { B as Button, m as motion } from "./button-729YJdzS.js";
import { L as Label, I as Input } from "./label-ZGRyn8Jx.js";
import { D as DEHRADUN_LOCALITIES } from "./vendorDatabase-ykqHyDSq.js";
import { u as ue } from "./index-BK91Y6U8.js";
import { S as Store } from "./store-D40pdK64.js";
import { C as CircleCheckBig } from "./circle-check-big-Cfmb5cNR.js";
import { B as Building2, C as CircleAlert } from "./circle-alert-D5ZgqqPV.js";
import { P as Phone } from "./phone-DmDsL88y.js";
import "./calendar-CPTWq_tt.js";
...
function VendorSetupPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Layout, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-muted/30 min-h-screen py-12", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container mx-auto px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.div,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-8", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "inline-flex items-center justify-center w-14 h-14 rounded-2xl bg-primary/10 border border-primary/20 mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Store, { size: 26, className: "text-primary" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display font-bold text-3xl text-foreground mb-2", children: "Set Up Your Vendor Profile" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm max-w-sm mx-auto", children: "List your business on EventIQ and get discovered by event planners in Dehradun." })
        ] }),
        ...
        savedProfile && !showSuccess && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center gap-2 mb-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Badge,
          {
            variant: "secondary",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-card border border-border rounded-2xl shadow-soft", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "form",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pt-2 flex flex-col sm:flex-row gap-3 border-t border-border", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Button,
                  {
                    type: "submit",
                    ...
                    children: savedProfile ? "Update Vendor Profile" : "Save Profile"
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  Button,
