import { r as reactExports, j as jsxRuntimeExports, R as React, b as reactDomExports, v as vt, c as cn } from "./index-BIH-J9QW.js";
import { a as composeRefs, u as useComposedRefs } from "./proxy-Cy-sNOcA.js";
import { X } from "./badge-C-VyKo_x.js";
import { v as vendorDatabase } from "./vendorDatabase-BRIdUTU4.js";
...
function buildBestFitVendors(keys, budget) {
  const result = {};
  ...
  for (const key of keys) {
    ...
    let chosen = (
      ...
      sorted.find((v) => v.cost <= perVendorShare) ?? // Fall back to initial tier preference
      vendors.find((v) => v.tier === initialTier) ?? // Last resort: cheapest available
